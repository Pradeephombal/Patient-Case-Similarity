...
def chatbot():
    ...
    try:
        ...
        prompt = f"The user has a disease with symptoms: {user_message}. Please recommend fruits, vegetables, and food items that are good for this condition dont give expalnation,only provide names of fruits and vegetables in separate lines with a line gap in between."
